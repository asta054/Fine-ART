                    ...
                    <div className="col-md-4">
                        <div class="card p-3" >
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mb-3 fs-4 ">Our Customizable</h5>
                    ...
                    <div className="col-md-4">
                        <div class="card p-3" >
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mb-3 fs-4 ">Fully Responsive Layout</h5>
                                <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                <a href="#" class="btn btn-primary">Go somewhere</a>
                            </div>
                        </div>
                    ...
                    <div className="col-md-4">
                        <div class="card p-3" >
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mb-3 fs-4 ">User Experoence</h5>
                                <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                <a href="#" class="btn btn-primary">Go somewhere</a>
                            </div>
                        </div>
                    ...
                    <div className="col-md-4">
                        <div class="card p-3" >
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mb-3 fs-4 ">Creative Web Design</h5>
                                <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                <a href="#" class="btn btn-primary">Go somewhere</a>
                            </div>
                        </div>
                    ...
                    <div className="col-md-4">
                        <div class="card p-3" >
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mb-3 fs-4 ">Unique and Clean</h5>
                                <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                <a href="#" class="btn btn-primary">Go somewhere</a>
                            </div>
                        </div>
                    ...
                    <div className="col-md-4">
                        <div class="card p-3" >
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mb-3 fs-4 ">Creative Idea</h5>
                                <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                <a href="#" class="btn btn-primary">Go somewhere</a>
                            </div>
                        </div>
